...
import { Bell, BellOff, BellRing, Moon } from "lucide-react";
...
export function NotificationSettings({ dndStart, dndEnd, timezone }: { dndStart: string | null; dndEnd: string | null; timezone: string }) {
